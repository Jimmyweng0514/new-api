...
export const ModelCard = memo(function ModelCard(props: ModelCardProps) {
  ...
  return (
    <div
      className={cn(
        'bg-card/75 group flex flex-col rounded-lg border border-border/70 p-3 shadow-[0_1px_2px_rgba(15,23,42,0.03)] transition-colors sm:p-4',
      ...
      <div className='flex items-start justify-between gap-2.5 sm:gap-3'>
        ...
        <div className='flex shrink-0 items-center gap-1.5'>
          <button
            ...
            className='text-muted-foreground hover:text-foreground hover:bg-muted inline-flex items-center gap-1 rounded-md border border-border/70 px-2 py-1 text-xs transition-colors sm:px-2.5 sm:py-1.5'
          >
            {t('Details')}
          ...
          <button
            type='button'
            onClick={handleCopy}
            className='text-muted-foreground hover:text-foreground hover:bg-muted rounded-md border border-border/70 p-1.5 transition-colors'
            title={t('Copy')}
          >
